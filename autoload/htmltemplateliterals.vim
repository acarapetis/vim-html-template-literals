function! htmltemplateliterals#amendSyntax()
  ...
  syntax region jsTemplateExpressionLitHtmlWrapper contained start=+${+ end=+}+ contains=jsTemplateExpression,@typescriptExpression keepend containedin=htmlString,htmlComment

  syntax region jsTemplateExpressionAsHtmlValue start=+=[\t ]*${+ end=++ contains=jsTemplateExpression,@typescriptExpression containedin=htmlTag
  " without this, htmlValue will match these expressions and overextend

endfunction

function! htmltemplateliterals#enableIndentation()
